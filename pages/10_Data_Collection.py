...
st.markdown("2. The Sentinel 2 bands have special resolution of 10 m and 20 m. The best freely available resolution. The bands include red, green, blue, red edge, and near infrared. Red edge resolution is 20 m, while the others 10 m.")
